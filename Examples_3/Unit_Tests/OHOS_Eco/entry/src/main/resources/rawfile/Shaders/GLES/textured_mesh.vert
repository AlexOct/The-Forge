...
// 2024-05-28 14:59:14.771748
// "..\..\..\..\..\Common_3\OS\UI\Shaders\FSL\textured_mesh.vert.fsl"
//--------------------------------------
...
STRUCT(VsIn)
{
#define _position_284
	DATA(float2, position, Position);
#define _texcoord_288
...
STRUCT(VsOut)
{
#define _position_316
	DATA(float4, position, SV_Position);
#define _texcoord_320
	DATA(float2, texcoord, TEXCOORD0);
};
#ifdef _texcoord_320
...
#endif
	VsOut Out;
	Out.position = float4(In.position.xy * Get_SCALEBIAS.xy + float2(-1.0, 1.0), 0.0, 1.0);
