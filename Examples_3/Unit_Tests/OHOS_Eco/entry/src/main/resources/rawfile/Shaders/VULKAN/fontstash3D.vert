...
#line 1 "../../../../../Common_3/OS/Fonts/Shaders/FSL/fontstash3D.vert.fsl"
#line 1 "D:/Third/The-Forge/Examples_3/Unit_Tests/Android_VisualStudio2017/Libraries/OS/../../../../../Common_3/OS/Fonts/Shaders/FSL/resources.h"
/*
...
#endif
#line 2 "D:/Third/The-Forge/Examples_3/Unit_Tests/Android_VisualStudio2017/Libraries/OS/../../../../../Common_3/OS/Fonts/Shaders/FSL/fontstash3D.vert.fsl"

STRUCT(VsIn)
{
#define _position_886
#line 5
	DATA(float2, position, Position);
#define _texCoord_891
#line 6
...
STRUCT(PsIn)
{
#define _position_907
#line 11
	DATA(float4, position, SV_Position);
#define _texCoord_912
#line 12
	DATA(float2, texCoord, TEXCOORD0);
};
#ifdef _texCoord_912
...
//	INIT_MAIN;
	PsIn Out;
	Out.position = mul(Get(mvp), float4(In.position * Get(scaleBias).xy, 1.0f, 1.0f));
