...
// 2024-05-28 14:59:08.938158
// "..\..\..\..\..\Common_3\OS\Fonts\Shaders\FSL\fontstash.frag.fsl"
//--------------------------------------
...
void main()
{
	PsIn In;
#ifdef _position_422
	In.position = float4(float4(gl_FragCoord.xyz, 1.0 / gl_FragCoord.w));
#endif
#ifdef _texCoord_426
	In.texCoord = texCoord;
#endif
	float4 Out;
	Out = float4(1.0, 1.0, 1.0, SampleTex2D(Get_UTEX0, Get_USAMPLER0, In.texCoord).r) * Get_COLOR;
	{
		gl_FragColor = Out;
	}
}